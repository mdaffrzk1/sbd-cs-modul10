...
class User {
  ...
  // Manfaatkan query menggunakan JOIN untuk riwayat
  static async getTransactionHistory(userId) {
    const result = await db.query(
      `SELECT t.id as transaction_id, t.quantity, t.total, t.status, t.description, t.created_at,
  ...
  // Manfaatkan query agregasi SUM() untuk menghitung total pengeluaran
